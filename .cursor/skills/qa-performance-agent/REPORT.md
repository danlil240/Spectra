...
- `plans/QA_results.md`
- `plans/QA_update.md`
- `.cursor/skills/qa-performance-agent/SKILL.md`
...
Change: `.cursor/skills/qa-performance-agent/SKILL.md` updated under `## Interpretation Rules` with three new bullets.
...
Change: `.cursor/skills/qa-performance-agent/SKILL.md` updated under `## Interpretation Rules` with one new signature-based rule.
