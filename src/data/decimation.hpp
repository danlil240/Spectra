...
[[nodiscard]] std::vector<std::pair<float, float>> min_max_decimate(std::span<const float> x,
                                                                    std::span<const float> y,
...
[[nodiscard]] std::vector<std::pair<float, float>> resample_uniform(std::span<const float> x,
                                                                    std::span<const float> y,
