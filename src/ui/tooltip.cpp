...
void Tooltip::draw(const NearestPointResult& nearest, float window_width, float window_height) {
    ...
    if (std::abs(opacity_ - target_opacity_) < 0.01f) opacity_ = target_opacity_;
    ...
    float content_w = std::max({name_size.x + swatch_size + 6.0f, coord_size.x, idx_size.x, min_width});
    ...
    ImGui::PushStyleColor(ImGuiCol_WindowBg, ImVec4(
        colors.tooltip_bg.r, colors.tooltip_bg.g, colors.tooltip_bg.b, colors.tooltip_bg.a));
    ImGui::PushStyleColor(ImGuiCol_Border, ImVec4(
        colors.tooltip_border.r, colors.tooltip_border.g, colors.tooltip_border.b, colors.tooltip_border.a));
    ...
    if (ImGui::Begin("##data_tooltip", nullptr, flags)) {
        ...
        dl->AddRectFilled(
            ...
            ImGui::ColorConvertFloat4ToU32(ImVec4(series_color.r, series_color.g, series_color.b, series_color.a)),
            2.0f);
        ImGui::SetCursorPosX(ImGui::GetCursorPosX() + swatch_size + 6.0f);
        ImGui::PushStyleColor(ImGuiCol_Text, ImVec4(
            colors.text_primary.r, colors.text_primary.g, colors.text_primary.b, colors.text_primary.a));
        ImGui::TextUnformatted(series_name);
        ImGui::PopStyleColor();

        // Row 2: coordinates
        ImGui::PushStyleColor(ImGuiCol_Text, ImVec4(
            colors.text_secondary.r, colors.text_secondary.g, colors.text_secondary.b, colors.text_secondary.a));
        ImGui::TextUnformatted(coord_line);
        ImGui::PopStyleColor();

        // Row 3: point index
        ImGui::PushStyleColor(ImGuiCol_Text, ImVec4(
            colors.text_tertiary.r, colors.text_tertiary.g, colors.text_tertiary.b, colors.text_tertiary.a));
    ...
    if (nearest.found && nearest.distance_px <= snap_radius_px_) {
        ...
        ImU32 dot_color = ImGui::ColorConvertFloat4ToU32(ImVec4(
            series_color.r, series_color.g, series_color.b, opacity_));
        ImU32 ring_color = ImGui::ColorConvertFloat4ToU32(ImVec4(
            colors.bg_primary.r, colors.bg_primary.g, colors.bg_primary.b, opacity_));
