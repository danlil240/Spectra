...
Logger::LogSink console_sink() {
    return [](const Logger::LogEntry& entry) {
        ...
        switch (entry.level) {
            case LogLevel::Trace:   color_code = "\033[37m"; break;
            case LogLevel::Debug:   color_code = "\033[36m"; break;
            case LogLevel::Info:    color_code = "\033[32m"; break;
            case LogLevel::Warning: color_code = "\033[33m"; break;
            case LogLevel::Error:   color_code = "\033[31m"; break;
            case LogLevel::Critical:color_code = "\033[35m"; break;
        }
        
        std::cout << color_code 
                  << Logger::timestamp_to_string(entry.timestamp) << " "
