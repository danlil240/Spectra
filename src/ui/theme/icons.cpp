...
void IconFont::build_icon_map()
{
    ...
    static constexpr Icon all[] = {
        Icon::ChartLine,     Icon::ScatterChart,
        Icon::Axes,          Icon::Wrench,
        Icon::Folder,        Icon::Settings,
        Icon::Help,          Icon::ZoomIn,
        Icon::Hand,          Icon::Ruler,
        Icon::Crosshair,     Icon::Pin,
        ...
        Icon::Palette,       Icon::LineWidth,
        Icon::Plus,          Icon::Minus,
        Icon::Play,          Icon::Pause,
        Icon::Stop,          Icon::StepForward,
        Icon::StepBackward,  Icon::Sun,
        Icon::Moon,          Icon::Contrast,
        Icon::Layout,        Icon::SplitHorizontal,
        Icon::SplitVertical, Icon::Tab,
        Icon::LineChart,     Icon::BarChart,
        Icon::PieChart,      Icon::Heatmap,
        Icon::ArrowUp,       Icon::ArrowDown,
        Icon::ArrowLeft,     Icon::ArrowRight,
        Icon::Refresh,       Icon::Clock,
        Icon::Calendar,      Icon::Tag,
        Icon::Link,          Icon::Unlink,
        Icon::Lock,          Icon::Unlock,
        Icon::Command,       Icon::Keyboard,
        Icon::Shortcut,      Icon::FolderOpen,
        Icon::File,          Icon::FileText,
        Icon::Grid,          Icon::List,
        Icon::Fullscreen,    Icon::FullscreenExit,
        Icon::Edit,          Icon::Scissors,
        Icon::Trash,         Icon::Duplicate,
        Icon::Function,      Icon::Integral,
        Icon::Sigma,         Icon::Sqrt,
        Icon::Circle,        Icon::Square,
        Icon::Triangle,      Icon::Diamond,
        Icon::Cross,         Icon::PlusMarker,
        Icon::MinusMarker,   Icon::Asterisk,
        Icon::LineSolid,     Icon::LineDashed,
        Icon::LineDotted,    Icon::LineDashDot,
        Icon::Home,          Icon::Back,
