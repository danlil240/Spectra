...
class RosPlotManagerTest : public ::testing::Test
{
   protected:
    ...
    bool spin_until(std::function<bool()> condition, std::chrono::milliseconds timeout = 3000ms)
    {
...
TEST_F(RosPlotManagerTest, AddPlotInvalidFieldPathRejected)
{
    ...
    PlotHandle h = mgr_->add_plot("/rpm_reject_1", "nonexistent.path", "std_msgs/msg/Float64");
    EXPECT_EQ(h.id, -1);
    EXPECT_EQ(mgr_->plot_count(), 0u);
}
...
{
    PlotHandle h = mgr_->add_plot("/rpm_float64_a", "data", "std_msgs/msg/Float64");
    EXPECT_GE(h.id, 1);
    EXPECT_TRUE(h.valid());
...
{
    PlotHandle h = mgr_->add_plot("/rpm_float64_b", "data", "std_msgs/msg/Float64");
    ASSERT_TRUE(h.valid());
...
{
    PlotHandle h = mgr_->add_plot("/rpm_float64_c", "data", "std_msgs/msg/Float64");
    ASSERT_TRUE(h.valid());
...
{
    PlotHandle h = mgr_->add_plot("/rpm_float64_d", "data", "std_msgs/msg/Float64");
    ASSERT_TRUE(h.valid());
...
{
    PlotHandle h = mgr_->add_plot("/rpm_lbl_test", "data", "std_msgs/msg/Float64");
    ASSERT_TRUE(h.valid());
...
{
    PlotHandle h = mgr_->add_plot("/cmd_vel_lbl", "linear.x", "geometry_msgs/msg/Twist");
    ASSERT_TRUE(h.valid());
...
{
    PlotHandle h = mgr_->add_plot("/rpm_color_0", "data", "std_msgs/msg/Float64");
    ASSERT_TRUE(h.valid());
...
{
    PlotHandle h = mgr_->add_plot("/rpm_axes_cnt", "data", "std_msgs/msg/Float64");
    ASSERT_TRUE(h.valid());
...
{
    PlotHandle h = mgr_->add_plot("/rpm_series_cnt", "data", "std_msgs/msg/Float64");
    ASSERT_TRUE(h.valid());
...
{
    PlotHandle h = mgr_->add_plot("/rpm_empty_data", "data", "std_msgs/msg/Float64");
    ASSERT_TRUE(h.valid());
...
{
    PlotHandle h = mgr_->add_plot("/cmd_vel_x", "linear.x", "geometry_msgs/msg/Twist");
    EXPECT_TRUE(h.valid());
...
{
    PlotHandle h = mgr_->add_plot("/cmd_vel_az", "angular.z", "geometry_msgs/msg/Twist");
    EXPECT_TRUE(h.valid());
...
{
    PlotHandle h = mgr_->add_plot("/rpm_lookup_a", "data", "std_msgs/msg/Float64");
    ASSERT_TRUE(h.valid());
...
{
    PlotHandle h = mgr_->add_plot("/rpm_ptr_check", "data", "std_msgs/msg/Float64");
    ASSERT_TRUE(h.valid());
...
{
    PlotHandle h = mgr_->add_plot("/rpm_remove_a", "data", "std_msgs/msg/Float64");
    ASSERT_TRUE(h.valid());
    EXPECT_EQ(mgr_->plot_count(), 1u);
...
{
    PlotHandle h = mgr_->add_plot("/rpm_remove_b", "data", "std_msgs/msg/Float64");
    ASSERT_TRUE(h.valid());
...
{
    PlotHandle h = mgr_->add_plot("/rpm_poll_empty", "data", "std_msgs/msg/Float64");
    ASSERT_TRUE(h.valid());
...
TEST_F(RosPlotManagerTest, OnDataCallbackReceivesCorrectPlotId)
{
    ...
    mgr_->set_on_data([&](int id, double, double) { received_id = id; });
