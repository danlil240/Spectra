...
void demo_basic_line()
{
    ...
    std::cout << "   Rendered " << img.width << "x" << img.height << " image (" << img.size_bytes()
              << " bytes)\n";
...
void demo_performance()
{
    ...
    std::cout << "   Image size: " << img.width << "x" << img.height << " (" << img.size_bytes()
              << " bytes)\n";
...
int main()
{
    ...
    try
    {
        ...
        const char* files[] = {"easy_embed_demo.png",
                               "scatter_demo.png",
                               "multi_demo.png",
                               "histogram_demo.png",
                               "labeled_demo.png"};
