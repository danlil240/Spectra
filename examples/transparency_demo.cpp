...
int main()
{
    ...
    // ── Subplot 3: Wireframe surface ─────────────────────────────────────
    {
        ...
        s.color(Color{0.3f, 0.7f, 1.0f, 0.8f}).wireframe(true);
    ...
    // ── Subplot 4: Transparent mesh with opacity control ─────────────────
    {
        ...
        std::vector<uint32_t> indices = {
            0,  1, 2,  0, 2, 3,  0, 3, 4,  0, 4, 5,  0, 5, 1,  1,  6, 2,  2, 7,
            3,  3, 8,  4, 4, 9,  5, 5, 10, 1, 6, 7,  2, 7, 8,  3,  8, 9,  4, 9,
            10, 5, 10, 6, 1, 11, 7, 6, 11, 8, 7, 11, 9, 8, 11, 10, 9, 11, 6, 10,
        };
