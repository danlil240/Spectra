...
- [EXPLORATION.md](EXPLORATION.md) — exploration tracker (modules analyzed vs pending)
- [REPORT.md](REPORT.md) — applied simplifications and candidate backlog
...
1. **Read** [EXPLORATION.md](EXPLORATION.md) to see current progress.
...
After build: [spectra-mcp](../spectra-mcp/SKILL.md) (`ping`, plot, screenshot). Full loop: [graphical-change-workflow](../graphical-change-workflow/SKILL.md).
