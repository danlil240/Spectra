...
private:
    ...
    void draw_dashed_line_impl(float x0, float y0, float x1, float y1,
                               unsigned int col, float thickness) const;
    void draw_corner_handles_impl(float x0, float y0, float x1, float y1,
                                  unsigned int col) const;
    void draw_dimension_label_impl(float x0, float y0, float x1, float y1,
                                   unsigned int col) const;
    void draw_zoom_crosshair_impl(float x0, float y0, float x1, float y1,
