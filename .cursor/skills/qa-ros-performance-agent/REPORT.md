...
- `.cursor/skills/qa-ros-performance-agent/REPORT.md`
...
- Updated `.cursor/skills/qa-ros-performance-agent/SKILL.md` to document the new mode and scenario.

**Files changed**
- `tests/qa/ros_qa_agent.cpp`
- `.cursor/skills/qa-ros-performance-agent/SKILL.md`
- `.cursor/skills/qa-ros-performance-agent/REPORT.md`
