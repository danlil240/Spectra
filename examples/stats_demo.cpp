...
int main()
{
    ...
    bp.add_box(1.0f, a).add_box(2.0f, b).add_box(3.0f, c)
      .add_box(4.0f, d).add_box(5.0f, e);
    ...
    vn.add_violin(1.0f, a).add_violin(2.0f, b).add_violin(3.0f, c)
      .add_violin(4.0f, d).add_violin(5.0f, e);
