...
## Design-Review Screenshot Coverage (63 total)
...
### Settings panel (57–62, G-6)
| # | Name | What it covers |
|---|------|----------------|
| 57 | `57_settings_appearance_night` | Settings → Appearance tab, night theme |
| 58 | `58_settings_appearance_light` | Settings → Appearance tab, light theme |
| 59 | `59_settings_appearance_high_contrast` | Settings → Appearance tab, high_contrast theme |
| 60 | `60_settings_shortcuts_night` | Settings → Shortcuts table, night theme |
| 61 | `61_settings_shortcuts_light` | Settings → Shortcuts table, light theme (warning token) |
| 62 | `62_settings_ui_defaults` | Settings → UI Defaults checkboxes |
...
The agent writes to `.cursor/skills/qa-designer-agent/REPORT.md` at the end of every session.
