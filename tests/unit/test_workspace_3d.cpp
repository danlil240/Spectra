...
TEST(Workspace3DRoundTrip, EmptyWorkspace) {
    ...
    std::string path = "/tmp/plotix_test_ws3d_empty.plotix";
...
TEST(Workspace3DRoundTrip, SingleAxes3D) {
    ...
    std::string path = "/tmp/plotix_test_ws3d_single.plotix";
    ASSERT_TRUE(Workspace::save(path, data));
...
TEST(Workspace3DRoundTrip, Mixed2DAnd3DAxes) {
    ...
    std::string path = "/tmp/plotix_test_ws3d_mixed.plotix";
    ASSERT_TRUE(Workspace::save(path, data));
...
TEST(Workspace3DRoundTrip, Series3DMetadata) {
    ...
    std::string path = "/tmp/plotix_test_ws3d_series.plotix";
    ASSERT_TRUE(Workspace::save(path, data));
...
TEST(Workspace3DRoundTrip, ModeTransitionState) {
    ...
    std::string path = "/tmp/plotix_test_ws3d_mt.plotix";
    ASSERT_TRUE(Workspace::save(path, data));
...
TEST(Workspace3DBackwardCompat, V3FileLoadsWithDefaults) {
    ...
    std::string path = "/tmp/plotix_test_ws3d_v3compat.plotix";
    {
        std::ofstream f(path);
        f << v3_json;
    }
...
TEST(Workspace3DMultiple, TwoAxes3DInOneFigure) {
    ...
    std::string path = "/tmp/plotix_test_ws3d_multi.plotix";
    ASSERT_TRUE(Workspace::save(path, data));
...
TEST(Workspace3DCamera, CameraInWorkspaceRoundTrip) {
    ...
    std::string path = "/tmp/plotix_test_ws3d_cam.plotix";
    ASSERT_TRUE(Workspace::save(path, data));
...
TEST(Workspace3DSpecialChars, LabelsWithSpecialChars) {
    ...
    std::string path = "/tmp/plotix_test_ws3d_special.plotix";
    ASSERT_TRUE(Workspace::save(path, data));
...
TEST(Workspace3DLighting, LightingDisabled) {
    ...
    std::string path = "/tmp/plotix_test_ws3d_light.plotix";
    ASSERT_TRUE(Workspace::save(path, data));
...
TEST(Workspace3DFull, CompleteStateRoundTrip) {
    ...
    std::string path = "/tmp/plotix_test_ws3d_full.plotix";
    ASSERT_TRUE(Workspace::save(path, data));
