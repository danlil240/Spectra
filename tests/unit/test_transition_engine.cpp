...
TEST(TransitionEngine, AllEasingFunctionsHaveCorrectEndpoints) {
    EasingFn fns[] = {
        ease::linear, ease::ease_in, ease::ease_out,
        ease::ease_in_out, ease::bounce, ease::elastic,
        ease::spring, ease::decelerate
    };
    for (auto fn : fns) {
...
TEST(TransitionEngine, EasingOutputBoundedForMonotonicFunctions) {
    EasingFn monotonic[] = {
        ease::linear, ease::ease_in, ease::ease_out,
        ease::ease_in_out, ease::decelerate
    };
