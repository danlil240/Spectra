...
Change: `tests/qa/qa_agent.cpp` (new scenario + expected count 54→55), `.cursor/skills/qa-designer-agent/SKILL.md` (coverage table/count + backlog status).
...
Change: `src/ui/imgui/widgets.cpp`, `imgui_animation.cpp` (×2), `imgui_panels.cpp`, `imgui_command_bar.cpp` — all `AddLine` separator sites; `.cursor/skills/qa-designer-agent/SKILL.md` (Fix Patterns + DES-I4 backlog).
...
Change: `tests/qa/qa_agent.cpp` (new scenario + expected count 53→54), `.cursor/skills/qa-designer-agent/SKILL.md` (coverage table/count + backlog status).
...
Change: `tests/qa/qa_agent.cpp` (new scenario + expected count), `.cursor/skills/qa-designer-agent/SKILL.md` (coverage table/count + backlog status).
